...
namespace LCD1IN8 {
    ...
    //% blockId=LCD_Filling
    //% blockGap=8
    //% block="Vul scherm met kleur %Color"
    //% weight=195
    ...
    //% blockId=LCD_SetBL
    //% blockGap=8
    //% block="Zet achtergrondverlichting op %Lev"
    ...
    //% blockId=Draw_Clear
    //% blockGap=8
    //% block="Maak scherm geheugen leeg"
    //% weight=195
    ...
    //% blockId=DrawPoint
    //% blockGap=8
    //% block="Teken punt|x %Xpoint|y %Ypoint|Kleur %Color|Grootte %Dot_Pixel"
	...
	//% blockId=DrawLine
	//% blockGap=8
	//% block="Teken lijn|Xstart %Xstart|Ystart %Ystart|Xeinde %Xend|Yeinde %Yend|Kleur %Color|Lijndikte %Line_width|Stijl %Line_Style"
    ...
    //% blockGap=8
    //% block="Teken Rechthoek|Xstart2 %Xstart2|Ystart2 %Ystart2|Xeinde2 %Xeinde2|Yeined2 %Yeinde2|Kleur %Color|Gevuld %Filled |Lijndikte %Dot_Pixel"
    ...
    //% blockId=DrawCircle
    //% blockGap=8
    //% block="Teken cirkel|X_midden %X_Center|Y_midden %Y_Center|Straal %Radius|Kleur %Color|Gevuld %Draw_Fill|Lijndikte %Dot_Pixel"
    ...
    //% blockId=DisString
    //% blockGap=8
    //% block="Teken tekst|X %Xchar|Y %Ychar|tekst %ch|Kleur %Color"
    ...
    //% blockId=DisNumber
    //% blockGap=8
    //% block="Teken cijfer|X %Xnum|Y %Ynum|Cijfer %num|Kleur %Color"
    ...
    * Select a color.
    */
    //% blockId="select_color" block="Kies kleur %Color"
